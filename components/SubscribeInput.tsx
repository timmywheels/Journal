                ...
                <div className='mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0'>
                    <button
                        ...
                        className={classNames(
                            ...
                            'w-full flex items-center justify-center px-5 py-3 border-b-4 border-green-600',
                    ...
                    >
                        ...
                        {!loading ?
                            <div className={`inline-block transition duration-150 ease-in-out tracking-wide`}>Subscribe</div> : null}
                    </button>
                </div>
            </form>
            <div>
