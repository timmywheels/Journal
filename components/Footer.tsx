    ...
    return (
        <footer className={'pt-12 py-24'}>
            <Container>
                ...
                <div className={''}>
                    <p className={'font-monospace text-sm font-medium text-center'}>From the <span
                        className={'text-xl'}>🧠</span> of <Link className={'font-bold underline'}
                                                                href={'https://timwheeler.com?ref=journal'}
                                                                target={'_blank'}>Tim Wheeler</Link></p>
                </div>
