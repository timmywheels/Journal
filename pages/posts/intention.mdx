---
title: Intention
description: The Journey to $1k MRR™
tag: 'buildinpublic'
date: 2023-01-05
---
...
# <HighlightedTitle text={"Intention"} size='text-3xl' />
...
I landed on [this](https://github.com/shuding/nextra/tree/main/examples/blog) minimal [Nextra](https://nextra.site/) project as it seemed to check all the boxes.

I've tweaked it a bit, so if you like it, go ahead and fork it!

👉 [https://github.com/timmywheels/journal](https://github.com/timmywheels/journal)
